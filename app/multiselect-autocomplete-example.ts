import { ElementRef, HostBinding, Component, OnInit, ViewChild, forwardRef, Input, Optional, Self, ChangeDetectorRef } from '@angular/core';
...
export class MultiselectAutocompleteExample implements OnInit, MatFormFieldControl<ItemList> {
